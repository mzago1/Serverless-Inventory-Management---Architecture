...
def import_inventory_data():
    ...
    write_restock_list_to_file(items_to_restock, timestamp)
    
    print("Data import completed.")

# Função para escrever a lista de itens para reposição em um arquivo de texto
def write_restock_list_to_file(items_to_restock, timestamp):
    try:
        # Extrair a data (ano, mês e dia) do timestamp
        year = timestamp.year
        month = timestamp.month
        day = timestamp.day
        ...
        print(f"List of items to restock saved to '{file_name}'.")
    except Exception as e:
